...
urlpatterns = [
    ...
    url(r'^macroproyecto/new/inventario/(?P<pk>\d+)$',views.MacroproyectoInventarioAutoView.as_view(),name='createAutoMacro4'),    
    url(r'^macroproyecto/new/incrementos/(?P<pk>\d+)$',views.MacroproyectoIncrementosAutoView.as_view(),name='createAutoMacro5'),        
    ## Proyectos
